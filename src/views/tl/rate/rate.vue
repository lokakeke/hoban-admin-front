              ...
              <v-card-text class="mt-8 pl-2 pr-5">
                <v-list dense v-if="branch && branch.length > 0" class="pr-5">
                  <transition-group type="transition" name="flip-list">
                    <v-list-item v-for="item of branch" :key="item.brcNo" @click="choiceBranch(item)" class="menu-list" :class="item.active? 'active' : ''">
                      <v-list-item-action>
          ...
          <v-flex xs12 md6 lg4 border-right>
            <v-card flat>
              ...
              <v-card-text class="mt-8 pl-5 pr-5">
                <v-list dense v-if="param.branch && agtCodeList && agtCodeList.length > 0" class="pr-5">
                  <transition-group type="transition" name="flip-list">
            ...
            <v-card flat>
              ...
              <v-card-text class="mt-8 pl-5 pr-5">
                <transition name="slide-fade" mode="out-in">
                  <template v-if="param.branch &&  param.agtCode">
...
export default {
  ...
  methods: {
    ...
    async commit() {
      this.form.brcNo = this.param.branch

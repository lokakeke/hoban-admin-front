                        ...
                        <template v-for="(item, index) in items">
                            ...
                            <template v-if="item.expand">
                                <tr v-for="detail of item.groupList" :key="detail.ticketNo + index"
                                    ...
                                    <td class="text-center">{{ detail.guestName }}</td>
                                    <td class="text-center">
...
export default {
  ...
  computed: {
    searchList () {
      return [
        ...
        { key: 'guestName', label: '이름', type: 'text' },
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: '이름', value: 'guestName', align: 'center' },
        { text: '전화번호', value: 'telNo', align: 'center' },
        { text: '상품명', value: 'itemName', align: 'center' },
  ...
  methods: {
    ...
    // 목록 조회
    search () {
      if (!this.searchParam.q.ticketNo && !this.searchParam.q.guestName && !this.searchParam.q.telNo) {

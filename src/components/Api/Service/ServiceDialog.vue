            ...
            <v-card tile>
                <div v-if="partnerInfo != null">
                    ...
                    <v-card-text class="subtitle-1">
                        <span class="mr-10">파트너명 : <span class="font-weight-bold">{{partnerInfo.partnerName}}</span></span>
...
export default {
  extends: DialogBase,
  components: { ApiServiceTab, InformationTab, IPTab },
  name: 'serviceDialog',
  data () {
    return {
      tab: null,
      tabs: [
        ...
        { title: 'IP 관리', component: 'IPTab', disable: true }
      ],
      partnerInfo: null,
      item: Object,
      isNew: Boolean,

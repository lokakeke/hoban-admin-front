    ...
    <v-form ref="form" lazy-validation autocomplete="off">
      <v-row>
        ...
        <v-col sm="6" md="4">
          ...
          <v-text-field v-model="form.ipName" label="" :rules="emptyRules" required></v-text-field>
        </v-col>
        <v-col sm="6" md="4">
...
export default {
  ...
  mounted () {
    ...
    this.serverCodeList = this.instance.params.serverCodeList
